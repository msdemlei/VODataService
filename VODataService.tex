...
standard protocols.
\item[RegTAP, v1.0 \citep{2014ivoa.spec.1208D}] RegTAP maps the concepts
...
ensure schema validation catches error, resource record authors are
advised to declare the type system intended using \xmlel{xsi:type}; for
instance, an SSAP service might declare:
...
\begin{lstlisting}[language=XML]
  <param std="true">
    ...
    <dataType arraysize="*" 
      ...
      extendedType="point">char</dataType>
  </param>
\end{lstlisting}
