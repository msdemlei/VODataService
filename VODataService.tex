...
the \xmlel{vs:TODOTODO} type that identifies a resource as data-like but
...
``Find all TAP services publishing tables from Gaia DR2''.\todo{I need a
...
discovering data collections \citep{note:DataCollect}, a more capabable type for
...
VODataService deprecates \xmlel{vs:DataCollection} for use with data
available online.  Use \xmlel{vs:TODOTODO} instead, with auxiliary
...
\item Adding an nrows element to \xmlel{vs:Table}.
