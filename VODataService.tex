...
\xmlel{vs:CatalogService}-s, including in particular essentially all
...
of \xmlel{vs:CatalogResources}-s to increase as more data collections
...
\begin{figure}
\begin{tabular}{p{0.27\textwidth}|p{0.27\textwidth}p{0.4\textwidth}}
...
The coverage uses three new types, \xmlel{vs:FloatInterval},
\xmlel{vs:ServiceReference}, and \xmlel{vs:SpatialCoverage}, defined as
follows:
